              ...
              <div>
                <form onSubmit={handleSubmit}>
                  <div className="flex flex-col gap-y-[9px]">
                    <div>
                      <input
                        className="px-[17px] rounded-[6px] bg-white outline-none w-full placeholder:text-sm placeholder:text-[#77787B] h-[50px] border border-darkBlue text-[#000]"
                        type="text"
                        id="name"
                        name="name"
                    ...
                    <div>
                      <input
                        className="px-[17px] rounded-[6px] border border-darkBlue bg-white outline-none w-full placeholder:text-sm placeholder:text-[#77787B] h-[50px] text-[#000]"
                        id="email"
                        name="email"
                    ...
                    <div>
                      <select
                        className="text-sm px-[17px] rounded-[6px] border border-darkBlue bg-white outline-none w-full h-[50px] text-[#77787B]"
                        id="product"
                        name="product"
                        onChange={handleChange}
                        required
                      >
                        <option value="default">Chọn loại vé*</option>
                        <option value="diamond">Vé Diamond (Miễn phí)</option>
                        <option value="gold">Vé Gold Member (6.100.000)</option>
                        <option value="member">Vé Member (7.600.000)</option>
                        <option value="standard">
                          Vé Tiêu chuẩn (14.300.000)
                        </option>
                      </select>
                    ...
                    {load === false ? (
                      <button
                        ...
                        className={`register-btn-popup shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25);] w-[289px] h-[60px] font-bold rounded-[50px] bg-red text-white border border-white border-solid ${
                          data.product === "default" ? "cursor-no-drop" : ""
                        }`}
                      >
                        ĐĂNG KÝ NGAY
                      </button>
